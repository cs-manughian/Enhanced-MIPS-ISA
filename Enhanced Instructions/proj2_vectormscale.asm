...
#
# File name:    	proj2_vectormscale.asm
# Version:      	1.0
# Date:         	April 10, 2015  
# Programmer:   	Cosi Manughian-Peter
#
# Description:  	This is an enhanced MIPS instruction that multiplies a vector by a scalar.   					 
#   		 The instruction format is as follows:
#
#   				vectormscale d, a, b, c
#
...
contMul:
   		 ...
   		 mult $t2, $s2   	     	 #Multiply the element by the scaling constant
   		 ...
   		 bne  $t3, $zero, contMul   	 #Continue until we reached the end of the vector
