...
#
# File name:        vector_mulo.asm
# Version:          1.0
# Date:             April 1, 2015  
# Programmer:       Nancy Torres
#
# Description:      This baseline instruction performs an vector multiply
#		odd integer operation. Each element of vector d is the   
#		full-length (16-bit) product of the corresponding low
#		(i.e. odd) half-width elements of vector a and vector b.
