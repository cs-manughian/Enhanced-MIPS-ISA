...
#
# File name:        proj2_matrixdetfp.asm
# Version:          1.0
# Date:             April 14, 2015  
...
#	 $t6: Identify row
#	 $t7: Identify column
#	 $f8: Temp for matrix values
#	 $f9: Temp for multiplying matrix values
#
...
main:	   #Initializations
	   ...
	   lwc1	$f5, 0($t4)		 # Load value of M[i][j]
 	   ...
 	   # We have M[1][1] in $t5
  	   ...
  	   mul.s  $f8, $f0, $f5		 # Multiply M[0][0]*M[1][1]
	   ...
	   lwc1	$f5, 0($t4)		 # Load value of M[i][j]
 	   ...
 	   mul.s  $f9, $f0, $f5		 # Multiply M[0][1]*M[1][0]
  	   
  	   # We have M[0][1]*M[1][0] in $t9
  	   
  	   # Calculate determinant
  	   sub.s  $f0, $f8, $f9		 # $s2 = M[0][0]*M[1][1] - M[0][1]*M[1][0]
